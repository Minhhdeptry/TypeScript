...
type checkNum = (num: number) => "even" | "odd";

const checkNumber: checkNum = (number) => {
...
const mergeProducts = (a: Products[], b: Products[]) : Products[]  => {
    return[...a, ...b];
}

const showProducts = (...products: Products[]): void => {
